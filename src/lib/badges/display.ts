...
> = {
  ...
  platinum: {
    badge: "border-sky-500/30 bg-sky-50 text-sky-900 dark:bg-sky-950/40 dark:text-sky-200",
...
export function describeTrustBadgeWhy(options: {
  ...
  if (!options.eligible) {
    return `Based on ${reviewLabel} over the last 3 months. At least 3 recent reviews are needed to earn a monthly badge.`;
  }
